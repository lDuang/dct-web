...
:root {
  ...
  --shadow-lg: 0 10px 15px -3px rgb(139 92 246 / 0.1), 0 4px 6px -4px rgb(0 0 0 / 0.1);
  --shadow-xl: 0 20px 25px -5px rgb(139 92 246 / 0.1), 0 8px 10px -6px rgb(0 0 0 / 0.1);
...
/* Mobile menu styles - will be merged with main responsive section */
...
.project-card:hover {
  transform: translateY(-4px);
  box-shadow: 0 20px 25px -5px rgb(139 92 246 / 0.1), 0 8px 10px -6px rgb(0 0 0 / 0.1);
}
