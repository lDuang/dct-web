  ...
  <footer class="footer">
    <div class="container">
      <div class="footer-content">
        <!-- 左侧列：典创工作室 和 友情链接 (合并为一个区块) -->
        <div class="footer-section footer-left-group">
        ...
        <!-- 右侧列：技术领域 和 联系我们 (合并为一个区块，内部垂直堆叠) -->
...
<script setup>
// No specific script logic for Footer section in original.
</script>
